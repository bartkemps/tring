...
/// </summary>
public class LookupBigTernaryArrayOperator
{
    private readonly BigTernaryArray ternaries;
    private readonly BinaryTritOperator table;

    internal LookupBigTernaryArrayOperator(BigTernaryArray ternaries, BinaryTritOperator table)
    {
    ...
    public static BigTernaryArray operator |(LookupBigTernaryArrayOperator left, BigTernaryArray right)
    {
    ...
    /// <param name="right">The right-hand operand.</param>
    /// <returns>A new BigTernaryArray with the operation applied.</returns>
    public static BigTernaryArray operator |(LookupBigTernaryArrayOperator left, TernaryArray right)
    {
        left.table.Apply(left.ternaries.Negative, left.ternaries.Positive, [right.Negative], [right.Positive], out var negative, out var positive);
