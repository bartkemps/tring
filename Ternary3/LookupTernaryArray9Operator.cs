...
/// </remarks>
public readonly struct LookupTernaryArray9Operator
{
    private readonly TernaryArray9 trits;
    private readonly BinaryTritOperator table;

    internal LookupTernaryArray9Operator(TernaryArray9 trits, BinaryTritOperator table)
    {
        this.trits = trits;
        this.table = table;
    }

    internal LookupTernaryArray9Operator(TernaryArray9 trits, Trit[,] table)
        : this(trits, new BinaryTritOperator(table))
    {
    }

    internal LookupTernaryArray9Operator(TernaryArray9 trits, ReadOnlySpan<Trit> table)
        : this(trits, new BinaryTritOperator(table))
    {
    }

    internal LookupTernaryArray9Operator(TernaryArray9 trits, Func<Trit, Trit, Trit> operation)
    ...
    /// </summary>
    /// <param name="left">The LookupTernaryArray9Operator containing the left operand and operation details.</param>
    /// <param name="right">The right TernaryArray9 operand.</param>
    /// <returns>A new TernaryArray9 representing the result of applying the binary operation to each corresponding pair of trits.</returns>
    public static TernaryArray9 operator |(LookupTernaryArray9Operator left, TernaryArray9 right)
    {
    ...
    /// <returns>A new TernaryArray9 representing the result of applying the binary operation to each corresponding pair of trits.</returns>
    public static TernaryArray9 operator |(LookupTernaryArray9Operator left, Int9T right)
    {
        var TernaryArray = (TernaryArray9)right;
    ...
    /// <returns>A new TernaryArray9 representing the result of applying the binary operation to each corresponding pair of trits.</returns>
    public static TernaryArray9 operator |(LookupTernaryArray9Operator left, Int16 right)
    {
