...
public class TritArray27BinaryOperationsTests
{
    ...
    public void And_SingleTrit_MatchesTritOperation(sbyte trit1Value, sbyte trit2Value)
    {
        ...
        var result = array1 | Binary.And | array2;
        var expected = trit1 | Binary.And | trit2;
    ...
    public void Or_SingleTrit_MatchesTritOperation(sbyte trit1Value, sbyte trit2Value)
    {
        ...
        var result = array1 | Binary.Or | array2;
        var expected = trit1 | Binary.Or | trit2;
    ...
    public void Xor_SingleTrit_MatchesTritOperation(sbyte trit1Value, sbyte trit2Value)
    {
        ...
        var result = array1 | Binary.Xor | array2;
        var expected = trit1 | Binary.Xor | trit2;
    ...
    [InlineData(1, 0)]
    [InlineData(1, 1)]
    public void Plus_SingleTrit_MatchesTritOperation(sbyte trit1Value, sbyte trit2Value)
    {
        var array1 = new TritArray27();
        var array2 = new TritArray27();
        var trit1 = new Trit(trit1Value);
        ...
        var result = array1 | Binary.Plus | array2;
        var expected = trit1 | Binary.Plus | trit2;

        result[0].Should().Be(expected, $"because {trit1} PLUS {trit2} should equal {expected}");
    }
    ...
    [InlineData(1, 0)]
    [InlineData(1, 1)]
    public void Minus_SingleTrit_MatchesTritOperation(sbyte trit1Value, sbyte trit2Value)
    {
        var array1 = new TritArray27();
        var array2 = new TritArray27();
        var trit1 = new Trit(trit1Value);
        ...
        var result = array1 | Binary.Minus | array2;
        var expected = trit1 | Binary.Minus | trit2;

        result[0].Should().Be(expected, $"because {trit1} MINUS {trit2} should equal {expected}");
    }
    ...
    public void BinaryOperations_PreserveOtherTrits()
    {
        ...
        var expected1 = array1[1] | Binary.And | array2[1];
        var expected2 = array1[2] | Binary.And | array2[2];
    ...
    public void BinaryOperations_OperateOnAllPositions()
    {
        var array1 = new TritArray27();
        var array2 = new TritArray27();
        var operations = new[] { Binary.And, Binary.Or, Binary.Xor, Binary.Plus, Binary.Minus };
