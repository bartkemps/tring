...
public class OperatorTests
{
    ...
    public void Notation()
    {
        ...
        var isNotNegativeResult2 = Trit.Positive | UnaryLookup.IsNotNegative; // or use ```static Import Tring.Operators.Operator;````
        ...
        var isEqualResult3 = -(Trit.Positive|BinaryLookup.Is | Trit.Negative); // or use ```static Import Tring.Operators.Operator;```.
