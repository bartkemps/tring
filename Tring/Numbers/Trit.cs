...
public readonly struct Trit: IEquatable<Trit>
{
    ...
    /// </remarks>
    public static TritOperator operator |(Trit left, Func<Trit, Trit, Trit> operation) => new(left, operation);
    ...
    /// </remarks>
    public static ArrayLookupTritOperator operator |(Trit left, Trit[,]lookupTable) => new(left, lookupTable);
