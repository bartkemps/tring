...
/// <summary>
/// Represents a ternary number, modeled after the <see cref="Int64"/> type.
/// </summary>
    ...
    ITernaryInteger<Int40T>
{
    ...
    /// </summary>
    public static Int40T MaxValue => new(MaxValueConstant);

    /// <summary>
    /// Represents the smallest possible value of a <see cref="Int40T"/>. This field is constant.
    /// </summary>
    public static Int40T MinValue => new(MinValueConstant);
